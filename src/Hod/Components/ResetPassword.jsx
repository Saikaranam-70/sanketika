...
const ResetPassword = () => {
    ...
    const generateOtp = async(e)=>{
        e.preventDefault();
        try {
            const responce = await fetch(`${API}/otp/get-otp`,{
                method:'POST',
                headers:{
    ...
    const verifyOtp = async(e)=>{
        e.preventDefault();
        try {
            const responce = await fetch(`${API}/otp/verify`,{
                method: 'POST',
                headers:{
                    'Content-Type': 'application/json'
                },
    ...
    const resetPassword = async(e)=>{
        e.preventDefault();
        try {
            const responce = await fetch(`${API_URL}/reset/change-hod-pass`, {
                method:'POST',
                headers:{
                    'Content-Type' : 'application/json'
                },
